                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="phone_number">
                                        <span style="color: red; font-weight: bold">*)</span> Phone Number
                                    </label>
                                    <input
                                        type="text"
                                        v-model="client.phone_number"
                                        v-bind:class="{ 'parsley-error': errors.phone_number }"
                                        required
                                        class="form-control"
                                    />
                                    <ul
                                    ...
                                    >
                                        <li
                                            class="parsley-required"
                                            v-for="(err, index) in errors.phone_number"
                                            :key="index"
                                        >{{ err }}</li>
                                    </ul>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="password">
                                        <span style="color: red; font-weight: bold">*)</span> Password
                                    </label>
                                    <input
                                        type="text"
                                        ...
                                        required
                                        class="form-control"
                                        v-bind:class="{ 'parsley-error': errors.password }"
                                    />
                                    <ul
                                        class="parsley-errors-list filled"
                                        id="parsley-id-9"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="password_confirmation">
                                        <span style="color: red; font-weight: bold">*)</span> Password Confirmation
                                    </label>
                                    <input
                                        type="email"
                                        ...
                                        required
                                        class="form-control"
                                        v-bind:class="{ 'parsley-error': errors.password_confirmation }"
                                    />
                                    <ul
                                        class="parsley-errors-list filled"
                                        id="parsley-id-9"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div v-if="edit_area">
                                <select
                                    ...
                                    v-bind:class="{ 'parsley-error': errors.province }"
                                >
                                    <option
                                ...
                                >
                                    <li
                                        class="parsley-required"
                                        v-for="(err, index) in errors.province"
                                        :key="index"
                                    >{{ err }}</li>
                                </ul>
                            </div>
                            <div
                                style="color: grey"
                                v-else
                            >{{ client.province ? client.province.name : 'Not Set' }}</div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div v-if="edit_area">
                                <select
                                    v-model="client.regency"
                                    class="form-control"
                                    @change="selectRegency"
                                    v-bind:class="{ 'parsley-error': errors.regency }"
                                >
                                    <option
                                        v-for="regency in area.regencies"
                                        :key="regency.id"
                                        :value="regency"
                                    >{{ regency.name }}</option>
                                </select>
                                ...
                                >
                                    <li
                                        class="parsley-required"
                                        v-for="(err, index) in errors.regency"
                                        :key="index"
                                    >{{ err }}</li>
                                </ul>
                            </div>
                            <div
                                style="color: grey"
                                v-else
                            >{{ client.regency ? client.regency.name : 'Not Set' }}</div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div v-if="edit_area">
                                <select
                                    ...
                                    class="form-control"
                                    v-bind:class="{ 'parsley-error': errors.district }"
                                >
                                    <option
                                ...
                                >
                                    <li
                                        class="parsley-required"
                                        v-for="(err, index) in errors.district"
                                        :key="index"
                                    >{{ err }}</li>
                                </ul>
                            </div>
                            <div
                                style="color: grey"
                                v-else
                            >{{ client.district ? client.district.name : 'Not Set' }}</div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div v-if="edit_area">
                                <textarea
                                    ...
                                    rows="4"
                                    class="form-control"
                                    v-bind:class="{ 'parsley-error': errors.address }"
                                ></textarea>
                                <ul
                                    class="parsley-errors-list filled"
                                    id="parsley-id-9"
                            ...
                            <div
                                style="color: grey"
                                v-else
                            >{{ client.address ? client.address : 'Not Set' }}</div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div v-if="edit_area">
                                <input
                                    ...
                                    class="form-control"
                                    v-bind:class="{ 'parsley-error': errors.zip_code }"
                                />
                                <ul
                                    class="parsley-errors-list filled"
                                    id="parsley-id-9"
                            ...
                            <div
                                style="color: grey"
                                v-else
                            >{{ client.zip_code ? client.zip_code : 'Not Set' }}</div>
                        </div>

                        <div class="clearfix">
                            <div class="pull-right">
                                <button
                                    v-if="edit_area == false"
                                    class="btn btn-primary"
                                    v-on:click="editArea"
                                >
                                    <i class="fa fa-cog"></i> Edit Address Detail
                                </button>
                                <button v-else class="btn btn-primary" v-on:click="editArea">
                                    <i class="fa fa-save"></i> Finish Editing Detail
                                </button>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        initData: function () {
            this.$axios
                .get("/admin_area/clients/" + this.$route.params.id)
                .then((res) => {
                    if (res.data.status == 1) {
                        this.client = res.data.data;

                        this.client.province = JSON.parse(
                            res.data.data.province
                        );
                        this.client.regency = JSON.parse(res.data.data.regency);
                        this.client.district = JSON.parse(
        ...
        saveData: function () {
            this.$swal({
                ...
                if (value) {
                    this.$axios
                        .put(
                            "/admin_area/clients/" + this.$route.params.id,
                            this.client
                        )
                        .then((res) => {
                            if (res.data.status == 1) {
