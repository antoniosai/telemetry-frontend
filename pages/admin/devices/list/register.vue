                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="name"><span style="color: red; font-weight: bold">*)</span> Full Name</label>
                                ...
                                <div class="form-group">
                                    <label for="code"><span style="color: red; font-weight: bold">*)</span> Device Code</label>
                                 
                                    <input type="text" v-model="form.code" required class="form-control" v-bind:class="{ 'parsley-error': errors.code }">
                                    <ul class="parsley-errors-list filled" id="parsley-id-9" v-if="errors.code">
                                        <li class="parsley-required" v-for="(err, index) in errors.code" :key="index">{{ err }}</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea v-model="form.description" rows="4" class="form-control" v-bind:class="{ 'parsley-error': errors.description }" ></textarea>
                            <ul class="parsley-errors-list filled" id="parsley-id-9" v-bind:class="{ 'parsley-error': errors.description }" v-if="errors.description">
                                <li class="parsley-required" v-for="(err, index) in errors.description" :key="index">{{ err }}</li>
                            </ul>
                        </div>
